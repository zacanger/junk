...
var charlie = devMountainEmployees.indexOf(cahlan)
devMountainEmployees.splice(charlie, 1)
console.log('and in that moment, ' + cahlan.name + ' swore he was infinite...')
setTimeout(function () {
  console.log("(it's a 'perks' reference. don't judge me.)")
}, 5000)

/* Now we're going to combine what we've learned today (objects) with what we learned yesterday (arrays). Yeah, take a deep breath. You're ready for this, promise. Let's think back to our iTunes example (tylermcginnis.com/itunes). Notice that when you type in an artist name, iTunes gives us back a LOT of data. What they're really giving us is an Array full of Objects. It probably looks something like this. */
...
following properties. name, email, password, username. Include this as one of the objects in your array. */
...
var user2 = {
  ...
  password: 'one.timeXXX.@bandcamp--lulz',
  username: 'r-walsh'
}
...
var user3 = {
  ...
  password: 'über.h|p$t3R',
  username: 'zacanger'
}

users.push(user1, user2, user3)

/* Now you have a very common data structure. Twitter is a good use case. It's easy to imagine that your followers list on Twitter is an Array full or objects and those objects contain properties about the specific person you follow. Now let's say that Tyler decided to delete his account. Loop through your array of objects until you find Tyler's account (use tylermcginnis33@gmail.com to find him). Once you find the particular index he's located in, delete him from the array. */

var tyler = users.map(function (id) {
  return id.email
}).indexOf('tylermcginnis33@gmail.com')
users.splice(tyler, 1)
