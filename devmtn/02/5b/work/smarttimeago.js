...
(function() {
  ...
  TimeAgo = (function() {
    ...
    TimeAgo.prototype.updateInterval = function() {
      ...
      if (this.$element.findAndSelf(this.options.selector).length > 0) {
        ...
        if (newestTimeInMinutes >= 0 && newestTimeInMinutes <= 44 && this.startInterval !== 60000) {
          ...
          return this.restartTimer();
        } else if (newestTimeInMinutes >= 90 && newestTimeInMinutes <= 2519 && this.startInterval !== 60000 *
          30) {
    ...
    TimeAgo.prototype.timeAgoInWords = function(timeString) {
      ...
      return "" + this.options.lang.prefixes.ago + (this.distanceOfTimeInWords(absolutTime)) + this.options.lang
        .suffix;
    };
    ...
    TimeAgo.prototype.distanceOfTimeInWords = function(absolutTime) {
      ...
      if (dim === 0) {
        ...
        return "" + this.options.lang.prefixes.about + " " + (Math.round(dim / 525600)) + " " + this.options.lang
          .units.years;
      }
    };
