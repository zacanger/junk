...
let MessageItem = class extends React.Component {
  render () {
    ...
    let rawMessageItem   = (
      <div className="message" dangerouslySetInnerHTML={{__html:formattedMessage}}></div>
    )

    if (this.props.message.type === 'message'){
      return (
        <div className="message-tem message">
          <Avatar user={this.props.message.user} />
          <div className="message-container">
            <div className="meta">
              <span className="author">{this.props.message.user.name}</span>
