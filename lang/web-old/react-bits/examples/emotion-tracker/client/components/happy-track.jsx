...
, EmotionSelector = require('./emotion-selector')
, HappyTrack      = React.createClass({
...
, render() {
    return (
      <div>
        ...
        <EmotionSelector
          initialEmotion={this.state.emotion}
          onChange={this.emotionChanged}
        />
        <label>
          Why?
          <textarea valueLink={this.linkState('why')} />
        </label>
