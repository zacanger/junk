...
, render(){
    const activeClass = 'left-nav-selected'
        ...
        <nav className='left-nav-links'>
          <ul>
            ...
            <li className='left-nav-link' id='nav-section2'>
              <Link
                to='section2'
                className={this.props.navSelection === 'nav-section2' ? activeClass : ''}
                activeClassName={activeClass}>
                Section 2
              </Link>
            </li>
            <li className='left-nav-link' id='nav-section3'>
              <Link
                to='section3'
                className={this.props.navSelection === 'nav-section3' ? activeClass : ''}
                activeClassName={activeClass}>
                Section 3
              </Link>
            </li>
