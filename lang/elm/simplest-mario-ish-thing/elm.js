...
Elm.Main.make = function (_elm) {
   ...
   var view = F2(function (_p0,mario) {
      ...
      var src = A2($Basics._op["++"],"/img/",A2($Basics._op["++"],verb,".png"));
      var marioImage = A3($Graphics$Element.image,100,100,src);
      ...
      _p4,
      _p3,
      _U.list([A2($Graphics$Collage.filled,A3($Color.rgb,255,255,255),A2($Graphics$Collage.rect,w,h))
              ,A2($Graphics$Collage.move,
              {ctor: "_Tuple2",_0: 0,_1: 24 - h / 2},
              A2($Graphics$Collage.filled,A3($Color.rgb,0,0,0),A2($Graphics$Collage.rect,w,50)))
   ...
   var update = F2(function (_p5,mario) {
      var _p6 = _p5;
      var _p8 = _p6._1;
      var _p7 = _p6._0;
      return A2(physics,_p7,A2(walk,_p8,A2(jump,_p8,A2(gravity,_p7,mario))));
   });
