...
use zterm_config_derive::ConfigDeserialize;
use zterm_terminal::config::LOG_TARGET_CONFIG;
use zterm_terminal::index::Column;

use crate::config::ui_config::Delta;

/// Default Zterm name, used for window title and class.
pub const DEFAULT_NAME: &str = "Zterm";
