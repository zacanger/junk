...
use zterm_terminal::config::{Config as TermConfig, LOG_TARGET_CONFIG};
...
mod tests {
    ...
    static DEFAULT_ZTERM_CONFIG: &str =
        concat!(env!("CARGO_MANIFEST_DIR"), "/../zterm.yml");

    #[test]
    fn config_read_eof() {
        let config_path: PathBuf = DEFAULT_ZTERM_CONFIG.into();
